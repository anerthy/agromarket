...
<head>
    ...
    <!-- CAROUSEL -->
    <link href="<?= media(); ?>/css/carousel_home.css" rel="stylesheet">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">La agricultura local a un
                                        clic de distancia</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">Descubre lo mejor de la
                                        agricultura local</h1>
                                    <!-- <a href="" class="btn btn-primary py-sm-3 px-sm-4">Explore More</a> -->
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-5 align-items-end">
                <div class="col-lg-3 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <img class="img-fluid rounded" data-wow-delay="0.1s"
                        src="<?= media(); ?>/images/img/plantilla/img/about.jpg">
                </div>
                <div class="col-lg-6 col-md-7 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">Únete a Agromarket hoy y sé parte de una plataforma dedicada al impulso del sector
                        agropecuario. Juntos, podemos fortalecer nuestras comunidades y crear oportunidades de
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-12 col-sm-6 col-lg-12">
                            <div class="border-start ps-4">
                                ...
                                <span>Establece contactos con otros miembros de la comunidad agrícola y
                                    empresarial.</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-8">
                <div class="pt-5">
                    ...
                    <p class="mb-0">
                        En Agromarket, somos más que una plataforma digital; somos una comunidad apasionada que une a
                        productores y consumidores en Nicoya y Santa Cruz. Nuestra historia se teje con la dedicación de
                        agricultores locales y la conexión directa con aquellos que valoran la frescura, la autenticidad
                        y la comunidad.
                    </p>
                </div>
            </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-8">
                <div class="pt-5">
                    ...
                    <p class="mb-0">
                        En Agromarket, nos dedicamos a potenciar la conexión directa entre los productores locales y los
                        consumidores en las vibrantes comunidades de Nicoya y Santa Cruz. Nuestra plataforma ofrece una
                        experiencia integral que abarca desde la promoción de actividades en ferias locales hasta la
                        presentación detallada de productos frescos y sus precios.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto wow fadeInUp"
                data-wow-delay="0.5s"
                style="max-width: 600px; visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
        ...
        <div class="container mv">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">
                        Facilitar y promover el encuentro entre productores agrícolas, emprendedores y la comunidad en
                        general, mediante la difusión clara y precisa de información sobre las ferias agropecuarias.
                    </p>
                    ...
                    <p class="mb-4">
                        En Agromarket, aspiramos a ser el principal referente en la difusión de eventos agrícolas,
                        convirtiéndonos en la plataforma preferida para agricultores y consumidores por igual.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">En Agromarket, nos preocupamos por facilitar tu llegada a las imperdibles ferias.
                        Para guiarte con precisión, hemos incorporado un mapa detallado en nuestro sitio web que puedes
                        consultar para planificar tu ruta.</a>.</p>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style="min-height: 450px;">
                    <div class="position-relative rounded overflow-hidden h-100">
                        <iframe class="position-relative w-100 h-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15709.663922105574!2d-85.45294767953472!3d10.146801913996205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f9fb6d26f825361%3A0xcbdc1416a01be4f3!2sProvincia%20de%20Guanacaste%2C%20Nicoya!5e0!3m2!1ses-419!2scr!4v1698256841525!5m2!1ses-419!2scr"
    ...
    <!-- <section class="anuncio">
        ...
        <center>
            <div class="col-lg-3 col-md-12 portfolio-item">
                <div class="rounded">
                    <img class="img-fluid"
                        src="<?= media(); ?>/images/uploads/anuncio/<?php echo $data['anuncio_principal'][$i]['anu_imagen']; ?>"
                        alt="<?php echo $data['anuncio_principal'][$i]['anu_descripcion']; ?>"
                        title="<?php echo $data['anuncio_principal'][$i]['anu_descripcion']; ?>" />
                </div>
            </div>
        </center>
        <?php  } ?>
