		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Solicitud de acceso para la cuenta: <strong><?= $dataEmail['email']; ?></strong></p>
					<p>Has solicitado los datos de tu usuario, acceda al enlace de abajo para confirmar tu contraseña. </p>
					<p class="x_text_white">
						<a href="<?= $dataEmail['url_recovery']; ?>" target="_blank" class="x_button_link x_link_blue">Cambiar contraseña</a>
					</p>
					<br>
					<p>Si no te funciona el botón puedes copiar y pegar la siguiente dirección en tu navegador:</p>
					<span><?= $dataEmail['url_recovery']; ?></span>
