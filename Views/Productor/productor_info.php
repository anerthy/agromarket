        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url(); ?>/productor/page">Productores</a></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-5 mb-5">Productores</h1>
            </div>
            <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded d-flex h-100">
                            ...
                            <div class="service-text rounded p-5">
                                ...
                                <a class="btn btn-sm" href="<?= base_url(); ?>/home/PerfilInInfo?usr_id=<?= $productor['usr_id'] ?>"><i class="fa fa-plus text-primary me-2"></i>Ir al perfil</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
