...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="<?= media(); ?>/images/img/plantilla/img/carousel-1.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="<?= media(); ?>/images/img/plantilla/img/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
    ...
    <!-- Quote Start -->
    <div class="container-fluid quote my-5 py-5" data-parallax="scroll" data-image-src="<?= media(); ?>/images/img/plantilla/img/carousel-2.jpg">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner rounded">
                        ...
                        <div class="portfolio-text">
                            ...
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?= media(); ?>/images/img/plantilla/img/service-1.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-inner rounded">
                        ...
                        <div class="portfolio-text">
                            ...
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?= media(); ?>/images/img/plantilla/img/service-2.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.5s">
                    <div class="portfolio-inner rounded">
                        ...
                        <div class="portfolio-text">
                            ...
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?= media(); ?>/images/img/plantilla/img/service-3.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner rounded">
                        ...
                        <div class="portfolio-text">
                            ...
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?= media(); ?>/images/img/plantilla/img/service-4.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-inner rounded">
                        ...
                        <div class="portfolio-text">
                            ...
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?= media(); ?>/images/img/plantilla/img/service-5.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.5s">
                    <div class="portfolio-inner rounded">
                        ...
                        <div class="portfolio-text">
                            ...
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?= media(); ?>/images/img/plantilla/img/service-6.jpg" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded">
                        <img class="img-fluid" src="<?= media(); ?>/images/img/plantilla/img/team-1.jpg" alt="">
                        <div class="team-text">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded">
                        <img class="img-fluid" src="<?= media(); ?>/images/img/plantilla/img/team-2.jpg" alt="">
                        <div class="team-text">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded">
                        <img class="img-fluid" src="<?= media(); ?>/images/img/plantilla/img/team-3.jpg" alt="">
                        <div class="team-text">
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                            <img class="img-fluid rounded mb-3" src="<?= media(); ?>/images/img/plantilla/img/testimonial-1.jpg" alt="">
                            <p class="fs-5">Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat.</p>
                            <h4>Client Name</h4>
                            <span>Profession</span>
                        </div>
                        <div class="testimonial-item">
                            <img class="img-fluid rounded mb-3" src="<?= media(); ?>/images/img/plantilla/img/testimonial-2.jpg" alt="">
                            <p class="fs-5">Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat.</p>
                            <h4>Client Name</h4>
                            <span>Profession</span>
                        </div>
