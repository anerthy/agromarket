    ...
    <header id="header" class="header d-flex align-items-center">
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            <a href="<?= base_url(); ?>" class="logo d-flex align-items-center">
                ...
                <img src="<?= media(); ?>/images/LOGOPARAISOAZUL.png" alt="Logo de Paraíso Azul">
                <!-- <h1>Paraíso Azul<span></span></h1> -->
            </a>
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a href="<?= base_url(); ?>">Inicio</a></li>
                    <li class="dropdown"><a href="#"><span>¿Qué ofrecemos?</span> <i
                    ...
                    <li class="dropdown"><a href="#"><span>Nosotros</span> <i
                                class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            ...
                            <li><a href="<?= base_url(); ?>/SobreNosotros/especies">Especies</a></li>
                        </ul>
                    </li>
