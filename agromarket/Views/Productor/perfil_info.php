...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="<?= media(); ?>/css/PerfilProductor_Info/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="<?= media(); ?>/css/PerfilProductor_Info/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="<?= media(); ?>/css/PerfilProductor_Info/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="<?= media(); ?>/css/PerfilProductor_Info/nice-select.css" type="text/css">
    <link rel="stylesheet" href="<?= media(); ?>/css/PerfilProductor_Info/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="<?= media(); ?>/css/PerfilProductor_Info/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="<?= media(); ?>/css/PerfilProductor_Info/slicknav.min.css" type="text/css">
        ...
        <div class="container">
            ...
            <div class="row featured__filter">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?= media(); ?>/images/img/Perfil-productor/featured/feature-3.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood oranges">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?= media(); ?>/images/img/Perfil-productor/featured/feature-4.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat vegetables">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?= media(); ?>/images/img/Perfil-productor/featured/feature-5.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fastfood">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?= media(); ?>/images/img/Perfil-productor/featured/feature-6.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat vegetables">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?= media(); ?>/images/img/Perfil-productor/featured/feature-7.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood vegetables">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?= media(); ?>/images/img/Perfil-productor/featured/feature-8.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="<?= media(); ?>/images/img/Perfil-productor/banner/banner-1.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="<?= media(); ?>/images/img/Perfil-productor/banner/banner-2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
