    ...
    <div class="row user">
        <div class="col-md-12">
            <div class="profile">
                <div class="info">
                    <img class="user-img"
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSR6uEHi2L1HNWSAF99KaXalj_S1HfyvTjzKw&usqp=CAU"
                        alt="Foto de perfil">
                </div>
                <div class="cover-image"
                    style="background-image: url('https://marketplace.canva.com/EAE8BWK0q3g/1/0/1600w/canva-fondo-de-pantalla-frutas-y-verduras-kawaii-naranja-Rtvd067L36k.jpg');">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-9">
            <div class="tab-content">
                <div class="tab-pane active" id="personal-info-tab">
                    ...
                    <h5 class="mb-4">DATOS PERSONALES <button class="btn btn-sm btn-info" type="button"
