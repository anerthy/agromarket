        ...
        <div class="tab-pane active" id="user-timeline">
          <div class="timeline-post">
            <div class="post-media">
              <div class="content">
                <h5>DATOS PERSONALES <button class="btn btn-sm btn-info" type="button" onclick="openModalProductor();"><i class="fas fa-pencil-alt" aria-hidden="true"></i></button></h5>
              </div>
            </div>
            ...
            <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  <td>Apellidos:</td>
                  <td><?= $_SESSION['userData']['ubicacion']; ?></td>
                </tr>
