...
require_once("Models/Traits/TEspecie.php");
...
{
    use TGrupo, TComunidad, TEspecie, TContenidos, TImagenes;
    ...
    public function proyecto()
    {
        ...
        $data['page_content'] = $this->getTextsProyecto();
        $data['page_media'] = $this->getImagesProyecto();
    ...
    public function especies()
    {
        ...
        $data['page_name'] = "viewespecies";
        $data['page_styles_css'] = "views_styles.css";
        $data['page_content'] = $this->getTextsEspecies();
        $data['page_content'] = $this->getTextsEspecies();
        $data['especies'] = $this->getEspeciesT();
