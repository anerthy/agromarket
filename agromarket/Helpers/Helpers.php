...
//Envio de correos
function sendEmail($dataEmail, $template)
{
    $asunto = $dataEmail['asunto'];
    $emailDestino = $dataEmail['email'];
...
{
    session_start();
    $inactive = 1800; //tiempo de sesion 30 minutos (60s)
...
function fechaNacimientoMaxima()
{
    return (date("Y") - 16) . '-12-31';
}
